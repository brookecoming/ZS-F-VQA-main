...
<img src="readmepics/vqa procedure.png" widht=400 height=300>
...
[//]: # (![ 文章来源:ISWC 2021 ][*Zero-shot Visual Question Answering using Knowledge Graph*]&#40;https://arxiv.org/abs/2107.05348&#41;)
...
- `2024-02`
  We preprint our
  Survey at arxiv: [Knowledge Graphs Meet Multi-Modal Learning: A Comprehensive Survey](http://arxiv.org/abs/2402.05391)

> https://arxiv.org/abs/2402.05391

- [`Repo for the servey above`](https://github.com/zjukg/KG-MM-Survey).
...
- Image folder (put all your `.JPEG`/`.jpg` file here):
    - `data/KG_VQA/fvqa/exp_data/images/images``` 此处下载后是个空的文件夹，需要往里手动添加h5文件.<br>
      (C:\ZS-F-VQA-main\data\KG_VQA\fvqa\exp_data\images\images\display_h5.py)
